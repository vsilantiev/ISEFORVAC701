#
# Created by System Generator     Mon Mar 26 15:47:34 2012
#
...
namespace eval ::xilinx::dsptool::iseproject::param {
    ...
    set NewXSTParser {1}
    set ProjectFiles {
        {{inout_logic_cw.vhd} -view All}
        {{inout_logic.vhd} -view All}
        {{inout_logic_cw.ucf}}
        {{C:\Temp\Xilinx PCI Express\ML605_ISE13.3\MySysGen\PCIe_UserLogic_00.mdl}}
    }
    set TopLevelModule {inout_logic_cw}
    set SynthesisConstraintsFile {inout_logic_cw.xcf}
